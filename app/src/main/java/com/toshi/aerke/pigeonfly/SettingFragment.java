...
public class SettingFragment extends Fragment {
    ...
    public void onStart() {
        ...
        useId =firebaseAuth.getCurrentUser().getUid();
        databaseReference = FirebaseDatabase.getInstance().getReference().child("User");
        if(useId!=null){
            databaseReference.child(useId).addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if(user!=null){
                        ...
                        Snackbar.make(name.getRootView(),"waiting for connection",Snackbar.LENGTH_LONG).show();
                    }
                }
