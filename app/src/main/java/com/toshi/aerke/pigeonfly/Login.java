                        ...
                        if(task.isSuccessful()){
                            FirebaseAuth.getInstance().signInWithEmailAndPassword(mEmail,mPassword)
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    Snackbar.make(mEmailView.getRootView(),e.getMessage(),Snackbar.LENGTH_LONG).show();
                                }
                            ...
                            try{
                                throw  task.getException();
                                        ...
                                        mEmailView.setError(email.getMessage());
                                             ...
                                             .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                                 ...
                                                 public void onComplete(@NonNull Task<AuthResult> task) {
                                                          if(task.isSuccessful()){
                                                              ...
                                                              Snackbar.make(mEmailView.getRootView(),task.getException().getMessage(),Snackbar.LENGTH_LONG).show();
                                                          }
                                                 }
                                             });
                            }catch
